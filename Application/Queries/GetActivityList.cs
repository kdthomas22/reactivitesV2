...
namespace Application.Queries
{
  public class GetActivityList
  {
    ...
    public class Handler : IRequestHandler<ActivityQuery, Result<List<ActivityDto>>>
    {
      ...
      {
        var activities = await _context.Activities.ProjectTo<ActivityDto>(_mapper.ConfigurationProvider, new {currentUsername = _userAccessor.GetUsername()}).ToListAsync();
